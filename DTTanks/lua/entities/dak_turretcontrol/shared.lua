...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Float", 	2, "YawMin", 	{ KeyName = "yawmin", 	Edit = { type = "Float", 		order = 3, min = 0, max = 180 } } )
	self:NetworkVar( "Float", 	3, "YawMax", 	{ KeyName = "yawmax", 	Edit = { type = "Float", 		order = 4, min = 0, max = 180 } } )
